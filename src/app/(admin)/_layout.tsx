  ...
  return (
    <Tabs
      ...
      <Tabs.Screen
        ...
        options={{
          title: 'Pricing',
          tabBarIcon: ({ color, focused }) => tabIcon(focused ? 'shield-checkmark' : 'shield-checkmark-outline', color, focused),
        }}
      />
      <Tabs.Screen
        name="operations"
      ...
      <Tabs.Screen
        ...
        options={{
          title: 'Settings',
          tabBarIcon: ({ color, focused }) => tabIcon(focused ? 'settings' : 'settings-outline', color, focused),
        }}
      />
    </Tabs>
  );
